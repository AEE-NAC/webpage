            ...
            <div className="flex space-x-4 overflow-x-auto scrollbar-hide">
                ...
                {SUPPORTED_COUNTRIES.map((country) => (
                    <Link
                        ...
                        className="px-4 py-1 text-sm text-[#fff] hover:text-white/80 cursor-pointer whitespace-nowrap transition-colors duration-200"
                    >
                        <span className="text-[#fff] text-sm font-bold">{country.name}</span>
                    </Link>
                ))}
            </div>
        </div>
