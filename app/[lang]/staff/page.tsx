...
export default async function StaffPage({ params }: { params: Promise<{ lang: SupportedLanguage }> }) {
    const { lang } = await params;
    const dictionary = await CMSService.getPageContent('staff', lang);
    ...
    return (
        <CMSProvider dictionary={dictionary}>
            ...
            <div className="hidden" aria-hidden="true">
                ...
                <CMSImage k="staff.member.belthane.image" defaultSrc="/placeholders/staff_1.jpg" alt="" width={1} height={1} />
                ...
                <CMSImage k="staff.member.guy.image" defaultSrc="/placeholders/staff_2.jpg" alt="" width={1} height={1} />
                <CMSText k="staff.member.bev.name" defaultVal="Bev Huff" />
                <CMSText k="staff.member.bev.role" defaultVal="Directeur Éducation" />
                <CMSImage k="staff.member.bev.image" defaultSrc="/placeholders/staff_3.jpg" alt="" width={1} height={1} />
                ...
                <CMSImage k="staff.member.janette.image" defaultSrc="/placeholders/staff_4.jpg" alt="" width={1} height={1} />
                ...
                <CMSImage k="staff.member.rodia.image" defaultSrc="/placeholders/staff_5.jpg" alt="" width={1} height={1} />
            </div>
